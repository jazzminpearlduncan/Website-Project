...
There are many examples below, and within each example you should start with the reference provided and find at least one more article (possibly from another angle?) to expand your understanding of the topic. It should be clear from your report what information came from which article.
